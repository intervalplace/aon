...
export declare function byteStream<Stream extends Duplex<any, any, any>, T extends ArrayBufferLike = ArrayBufferLike>(duplex: Stream, opts?: ByteStreamOpts): ByteStream<Stream, T>;
